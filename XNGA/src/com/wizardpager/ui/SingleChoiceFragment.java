...
public class SingleChoiceFragment extends ListFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		TextView tvTitle = (TextView) rootView.findViewById(android.R.id.title);
		tvTitle.setText(mPage.getTitle());
		...
		new Handler().post(new Runnable() {
			...
			public void run() {
				if (mChoices.size() > 0) {
					...
					mPage.getData().putString(Page.SIMPLE_DATA_KEY, getListAdapter().getItem(0).toString());
