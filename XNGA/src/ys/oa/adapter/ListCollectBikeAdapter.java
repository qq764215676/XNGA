 ...
 */
@SuppressLint("NewApi")
public class ListCollectBikeAdapter extends BaseAdapter {
	private ArrayList<CollectCarEnity> enityList;
	private Context context;

	public ListCollectBikeAdapter(Context context, ArrayList<CollectCarEnity> enityList) {
	...
	public View getView(final int position, View v, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.collect_bike_list_item, null);
			...
			holder.tv_car_address = (TextView) v.findViewById(R.id.tv_car_address);
			v.setTag(holder);
		} else {
		...
		holder.tv_car_address.setText(enityList.get(position).getAddress());
