 ...
 */
@SuppressLint("NewApi")
public class ListLostAdapter extends BaseAdapter {
	private ArrayList<LostEnity> enityList;
	private Context context;

	public ListLostAdapter(Context context, ArrayList<LostEnity> enityList) {
	...
	public View getView(final int position, View v, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = inflater.inflate(R.layout.lost_list_item, null);
		...
		holder.tv_lost_name.setText(enityList.get(position).getLostName());
		holder.tv_lost_info.setText(enityList.get(position).getLostIntro());
		holder.tv_lost_phone.setText(enityList.get(position).getLostPhone());
		holder.tv_lost_time.setText(enityList.get(position).getLostTime());
		return v;
	}
