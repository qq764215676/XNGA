...
import ys.oa.adapter.OrderWizardModel;
 ...
 * 
 */
public class RecordActivity extends Activity implements PageFragmentCallbacks, ReviewFragment.Callbacks, ModelCallbacks {
	private ViewPager mPager;
	private MyPagerAdapter mPagerAdapter;

	private boolean mEditingAfterReview;

	private AbstractWizardModel mWizardModel = new OrderWizardModel(this);
		...
		mNextButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if (mPager.getCurrentItem() == mCurrentPageSequence.size()) {
					loadingDialog = DialogLoading.getProgressDialog(RecordActivity.this, "正在上传");
					// 所有表项
					...
					try {
						DbUtils db = DbUtils.create(RecordActivity.this);
						RecordEnity enity = new RecordEnity();
					...
					new Handler().postDelayed(new Runnable() {
						@Override
						public void run() {
							// T.showShort(RecordActivity.this, "上传成功");
