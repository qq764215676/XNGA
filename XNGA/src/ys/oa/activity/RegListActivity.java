...
public class RegListActivity extends BaseActivity  implements PullToRefreshAttacher.OnRefreshListener {
	...
	class AsyncGetRegList extends AsyncTask<String, Integer, Integer> {
		...
		protected Integer doInBackground(String... params) {
			...
			if(Util.isNetworkAvailable(context)) {
				try {
					datasetlist = PostHttp.PostDocXML(XmlPackage.packageSelect("from XNGA_PATROL_REG where USER_ID='"
							+ Constants.USER_ID + "'" +" and  REG_TIME >"+ "'"+time+"'" + " order by REG_TIME desc", "", "", "", "SEARCHYOUNGCONTENT", new DocInfor("", "XNGA_PATROL_REG"), true,
							false));
				} catch (Exception e) {
