...
import ys.oa.adapter.OrderHomeWizardModel;
 ...
 * 
 */
public class RecordHomeActivity extends Activity implements PageFragmentCallbacks, ReviewFragment.Callbacks,
		ModelCallbacks {
	...
	private AbstractWizardModel mWizardModel = new OrderHomeWizardModel(this);
		...
		mNextButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if (mPager.getCurrentItem() == mCurrentPageSequence.size()) {
					// loadingDialog =
					// DialogLoading.getProgressDialog(RecordHomeActivity.this,
					// "正在上传");
					// 所有表项
					...
					// try {
					// DbUtils db = DbUtils.create(RecordHomeActivity.this);
					// enity = new RecordHomeEnity();
					// enity.setReviewItems(reviewItems);
					// db.save(enity);
					// } catch (DbException e) {
					...
					// @Override
					// public void run() {
					// // T.showShort(RecordHomeActivity.this, "上传成功");
	...
	class AsyncLoader extends AsyncTask<String, Integer, Integer> {
		...
		protected Integer doInBackground(String... params) {
			if ("upload".equals(params[0])) {
				...
				map.put("regTime", enity.getRegTime());
				map.put("regPoliceMan", enity.getRegPoliceMan());
				map.put("ownerName", enity.getOwnerName());
				map.put("ownerSex", enity.getOwnerSex());
				map.put("ownerId", enity.getOwnerId());
				map.put("ownerPhone", enity.getOwnerPhone());
				map.put("houseAddress", enity.getHouseAddress());
				map.put("houseUse", enity.getHouseUse());
				map.put("houseArea", enity.getHouseArea());
				map.put("peopleNum", enity.getPeopleNum());
				map.put("beginDate", enity.getBeginDate());
				map.put("endDate", enity.getEndDate());
				map.put("tenantName", enity.getTenantName());
				map.put("tenantSex", enity.getTenantSex());
				map.put("tenantId", enity.getTenantId());
				map.put("tenantHkAddress", enity.getTenantHkAddress());
