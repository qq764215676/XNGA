...
import ys.oa.fragment.CollectGoodFragment;
...
public class CollectGoodListActivity extends FragmentActivity {
	private CollectGoodFragment mContentFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("物品检查");
		mContentFragment = CollectGoodFragment.newInstance();
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode != Activity.RESULT_OK)
			return;
		ToastMsg.showMsgTop(CollectGoodListActivity.this, "上传成功");
		switch (requestCode) {
		case 0:
